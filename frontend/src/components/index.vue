        ...
        <div v-for="(group, groupName) in groupedMenu" :key="groupName">
          ...
          <div class="space-y-1">
            ...
            >
              ...
              />
              <span v-if="!sidebarCollapsed" class="relative z-10 whitespace-nowrap">{{
                item.label
              }}</span>
              <ChevronRight
      ...
      >
        ...
        <div class="flex justify-end items-center gap-3">
          ...
          >
            ...
            <span
              class="absolute top-1.5 right-1.5 w-2 h-2 bg-red-500 rounded-full border-2 border-white animate-pulse"
            ></span>
          </button>
        </div>
      </header>
